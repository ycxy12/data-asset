 ...
 * @param {Function} requestError 请求出错时的回调方法 (非必传)
 * */
export const useTable = (api, initParam = {}, isPageable = true, dataCallBack, requestError) => {
    ...
    const getTableList = async () => {
        ...
        try {
            ...
            let { data, totalCount } = await api({ ...state.searchInitParam, ...state.totalParam });
            if (dataCallBack) {
     ...
     * @param {pagination} val 当前页
     * @return void
     * */
    const handleTableChange = (pagination) => {
        state.pageable.pageNum = pagination.current;
        state.pageable.pageSize = pagination.pageSize;
        getTableList();
    };
